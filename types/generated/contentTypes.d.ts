...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    preferredclienttype: Attribute.Relation<
      ...
      'api::clienttype.clienttype'
    >;
    preferredcompany: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToOne',
      'api::company.company'
    >;
...
export interface ApiCompanyCompany extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    normalized_clients: Attribute.Relation<
      'api::company.company',
      'oneToMany',
    ...
    tickettypes: Attribute.Relation<
      ...
      'api::tickettype.tickettype'
    >;
    whatsappcontacts: Attribute.Relation<
      'api::company.company',
      'oneToMany',
